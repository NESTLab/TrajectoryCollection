#ifndef KHEPERA_MIXED_H
#define KHEPERA_MIXED_H
 ...
 */
class CKheperaMixed : public CCI_Controller {
...
private:
   ...
   // friend class CKheperaFlocking;
   // friend class CKheperaForaging;
   // friend class CKheperaObstacleAvoidance;
